...
/**
 * Created by HieuMinh on 3/22/2018.
 */
...
public class TypingCustomView extends View {

    private static final TypingIndicator DEFAULT_INDICATOR=new TypingIndicator();
    ...
    public TypingCustomView(Context context) {
        super(context);
        init(context, null,0,0);
    }

    public TypingCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0,R.style.TypingCustomView);
    }

    public TypingCustomView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr,R.style.TypingCustomView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public TypingCustomView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
